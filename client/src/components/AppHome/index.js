...
export default function AppHome() {
  return (
    <div id="appHome" style={{ backgroundImage: `url("/img/backapp.jpg")` }}>
      <Grid container className="appHome-container">
        <Grid item xs={6} className="appHome-left">
          <div>
            ...
            <br />
            <p className="appHome-left-text">Không chỉ đặt vé, bạn còn có thể bình luận phim, chấm điểm rạp và đổi quà hấp dẫn.</p>
            <br />
        ...
        <Grid item xs={6} className="appHome-right">
          <img src="/img/Mobile/mobile.png" alt="" className="appHome-right-phone-img" />
          <Carousel
            autoPlay={true}
            infiniteLoop={true}
          ...
          >
            {arrayCarouselMobile.map((item, index) => (
              <div className="appHome-right-carousel-item" key={index}>
                <img src={item.img} className="appHome-right-carousel-item-img" alt="" />
              </div>
            ))}
          </Carousel>
        </Grid>
